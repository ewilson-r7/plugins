...
| [zscaler](plugins/zscaler/) | 2.5.0 | Add Get Enrolled Devices and Get One-Time Password actions, enhance Update URLs of URL Category with parent-category URLs and activate config, fix Remove VPN Gateway Bypass deviceType error |
