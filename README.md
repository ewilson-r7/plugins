...
| [fortinet_fortimanager](plugins/fortinet_fortimanager/) | 3.1.0 | Add Get Address Group and List Address Groups actions; normalize FortiManager address responses to fix action crashes, remove Enable Search so Check if Address in Group always matches name and value, add Message output to all five address actions |
