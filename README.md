...
| [fortinet_fortimanager](plugins/fortinet_fortimanager/) | 3.0.0 | Normalize FortiManager address responses to fix action crashes, remove Enable Search so Check if Address in Group always matches name and value, add Message output to all five address actions |
