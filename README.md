...
| [fortinet_fortimanager](plugins/fortinet_fortimanager/) | 2.1.0 | Fix Enable Search logic, add comment input to Create Address Object, add graceful error handling, fix subnet/name filters in Get Address Objects |
...
| [zscaler](plugins/zscaler/) | 2.5.1 | Add Get Enrolled Devices and Get One-Time Password actions, enhance Update URLs of URL Category with parent-category URLs and activate config, fix Remove VPN Gateway Bypass deviceType error |
