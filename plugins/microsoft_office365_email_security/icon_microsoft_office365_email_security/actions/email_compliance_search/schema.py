...
class EmailComplianceSearchInput(insightconnect_plugin_runtime.Input):
    schema = json.loads(r"""
   {
  "type": "object",
  "title": "Variables",
  "properties": {
    ...
    "exchange_location": {
      ...
      "description": "Exchange location to limit this search to. An Exchange Location can be a mailbox, group mailbox, or 'All'. If this is ommitted it will be set to All",
      "default": "All",
      "order": 4
    },
    "query_timeout": {
...
class EmailComplianceSearchOutput(insightconnect_plugin_runtime.Output):
    schema = json.loads(r"""
   {
  "type": "object",
  "title": "Variables",
