...
from icon_microsoft_office365_email_security.actions.mass_purge import MassPurge
from icon_microsoft_office365_email_security.actions.mass_purge.schema import Output
from icon_microsoft_office365_email_security.connection.connection import Connection
from jsonschema import validate


class TestMassPurge(TestCase):
    def setUp(self) -> None:
        log = logging.getLogger("Test")
        test_conn = Connection()
        test_action = MassPurge()
    ...
    def test_success_mass_purge(self):
        COMPLETION_MESSAGE = "Script Complete"
        self.action.connection.client.configure_mock(**{"mass_purge.return_value": (COMPLETION_MESSAGE, None)})
