...
class Util:
    ...
    def default_connector(action: insightconnect_plugin_runtime.Action):
        ...
        default_connection.zcc_client._token = "mock-access-token-12345"
        default_connection.zcc_client._token_expiry = 9999999999
    ...
    def mock_request(*args, **kwargs):
        ...
        # Handle ZCC endpoints
        if "/zcc/papi/public/v1/web/policy/listByCompany" in url and method == "GET":
