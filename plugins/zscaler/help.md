...
#### Get VPN Gateway Bypasses

This action is used to retrieve VPN gateway bypass entries from ZCC application profiles for auditing shared-
...
|Name|Type|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- |
|profiles|[]vpn_gateway_profile|True|List of application profiles with VPN gateway bypass entries|[{"profile_id": "12345", "profile_name": "Default Profile", "vpn_gateways": [{"hostname": "gateway.example.com", "type": "hostname"}]}]|
...
#### Remove VPN Gateway Bypass

This action is used to remove a VPN gateway bypass entry from a ZCC application profile

##### Input

|Name|Type|Default|Required|Description|Enum|Example|Placeholder|Tooltip|
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
|entry|string|None|True|The hostname or IP address to remove from VPN gateway bypasses|None|gateway.example.com|None|None|
...
|Name|Type|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- |
|success|boolean|True|Whether the removal was successful|True|
|vpn_gateways|[]vpn_gateway_entry|True|Updated list of VPN gateway bypass entries|[{"hostname": "other-gateway.example.com", "type": "hostname"}]|
...
```
{
  ...
  "vpn_gateways": [
    {
      "hostname": "other-gateway.example.com",
      "type": "hostname"
    }
  ]
}
...
|Name|Type|Default|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- | :--- |
|Hostname|string|None|False|The hostname of the VPN gateway bypass entry|gateway.example.com|
|IP|string|None|False|The IP address of the VPN gateway bypass entry|10.0.0.1|
|Type|string|None|False|The type of entry (e.g., "hostname", "ip")|hostname|
  
**vpn_gateway_profile**

|Name|Type|Default|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- | :--- |
|Profile ID|string|None|True|The application profile ID|12345|
|Profile Name|string|None|True|The application profile name|Default Profile|
|VPN Gateways|[]vpn_gateway_entry|None|True|List of VPN gateway bypass entries|[{"hostname": "gateway.example.com", "type": "hostname"}]|
